...
var BraftFinderView = function (_React$Component) {
  ...
  _createClass(BraftFinderView, [{
    ...
    value: function mapPropsToState(props) {
      ...
      var external = {
        url: '',
        type: externals.image ? 'IMAGE' : externals.audio ? 'AUDIO' : externals.video ? 'VIDEO' : externals.embed ? 'EMBED' : externals.iframe ? 'IFRAME' : ''
      };
          ...
          showExternalForm && allowExternal ? _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                externals.iframe ? _react2.default.createElement(
                  'button',
        ...
        this.state.items.map(function (item, index) {
          ...
          switch (item.type) {
            ...
            case 'IFRAME':
              previewerComponents = _react2.default.createElement(
                'div',
                { className: 'bf-icon bf-iframe', title: item.url },
                progressMarker,
